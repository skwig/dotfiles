return {
  ...
  config = function()
    ...
    vim.keymap.set("x", "<leader>rmf", ":Refactor extract_to_file<CR>", { desc = "[R]efactor [M]ethod [F]ile" })
    ...
    vim.keymap.set("n", "<leader>rbf", ":Refactor extract_block_to_file<CR>", { desc = "[R]efactor [B]lock [F]ile" })
